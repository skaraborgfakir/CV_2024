...
\usepackage{tgadventor} % fet för rubriker
...
\usepackage{fancyhdr}
\fancyhf[LH]{Stefan Skoglund\\Wetterlinsgatan 15F\\521 34 Falköping}
\fancyhf[CH]{stefan.skoglund@agj.net\\%
  \href{http://www.linkedin.com/in/stefan-skoglund-skaraborg}{Linkedin:Stefan Skoglund}\\
  \href{https://github.com/Skaraborgfakir}{github: Skaraborgfakir}}
\fancyhf[RH]{0702--719 835}
\fancyhf[CF]{\href{https://skaraborgfakir.github.io/cv_generell_2024.pdf}{Länk till denna version}}
\pagestyle{fancy}
...
%%  \begin{description}[nosep]
    \raggedleft%
    \vspace{-\topskip+1cm}
    \includegraphics[height=3.5cm]{foto i Anten Mans.jpg}
    \includegraphics[angle=270,trim 2 2 2 2, width=3.5cm]{rhododendrondalen stenfond.jpg}
